    ...
    if turtle.getItemDetail(i) ~= nil then
      ...
      if 
        ...
        turtle.getItemDetail(i).name ~= "minecraft:gold_ore" and 
	    	turtle.getItemDetail(i).name ~= "minecraft:gold_nugget" and 
	    	turtle.getItemDetail(i).name ~= "minecraft:ancient_debris" and
	    	turtle.getItemDetail(i).name ~= "betternether:cincinnasite_ore" and
	    	turtle.getItemDetail(i).name ~= "minecraft:quartz" and
